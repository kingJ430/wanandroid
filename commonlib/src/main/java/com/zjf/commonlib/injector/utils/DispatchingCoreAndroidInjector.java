...
public final class DispatchingCoreAndroidInjector<T> implements AndroidInjector<T> {
    private static final String NO_SUPERTYPES_BOUND_FORMAT =
            "No com.taobao.meipingmi.injector factory bound for Class<%s>";
    private static final String SUPERTYPES_BOUND_FORMAT =
            "No com.taobao.meipingmi.injector factory bound for Class<%1$s>. Injector factories were bound for supertypes "
                    + "of %1$s: %2$s. Did you mean to bind an com.taobao.meipingmi.injector factory for the subtype?";
     ...
     *
     * @throws dagger.android.DispatchingAndroidInjector.InvalidInjectorBindingException if the com.taobao.meipingmi.injector factory bound for a class does not
...
//    @CanIgnoreReturnValue
     ...
     * {@code @FragmentKey(YourFragment.class)} matches the type argument of the com.taobao.meipingmi.injector factory.
     */
    @Beta
